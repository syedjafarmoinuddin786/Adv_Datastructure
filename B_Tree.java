...
public class BTree {
    ...
    public class Node {
        ...
        int[] key = new int[2 * T - 1]; // Array to store keys
        Node[] child = new Node[2 * T]; // Array to store child pointers
        boolean leaf = true; // Whether the node is a leaf

        // Method to find a key in the node
    ...
    // Helper method to remove a key from the B-tree
    ...
    // Method to remove keys in a given range
    ...
    // Helper method to find keys in a given range
    ...
    // Method to check if the B-tree contains a key
